...
app.controller('homeController', ['$scope', 'tempService', function ($scope, tempService) {
    $scope.myCtrlID = 0;
...
app.service('tempService', ['$http', '$log', function ($http, $log) {
    ...
    this.getBasicCtrl = function (ctrlType) {
        var myCtrl = [
                {"id":1,"Code":"String","Name":"Text Field","Description":"This is a text Field that allows any charactor input","DBType":"String","UIType":"Text Field","ConstraintForm":"BCF01"},
